...
## Варіанти завдань:
  ...
  1. Збільшити на 2. Збільшити вміст регістру $a0 на 2.
  2. Зменшити на 2. Зменшити вміст регістра $a0 на 2.
  3. Сума. Дадати вміст регістрів $a0 та $a1 і записати результат в $v0.
  4. Віднімання. Відняти вміст регістру $a1 від вмісту регістра $a0 і записати
  результат в $v0.
  5. Множення. Перемножити вміст регістрів $a0 і $a1 та записати результат в
  $v0.
  6. Ділення. Розділити вміст регістру $a0 на вміст регістру $a1 і записати цілу
  частину до $v0.
...
1. Збільшити на 2. Збільшити вміст регістру $a0 на 2.
 ...
 3. *Сума.*Дадати вміст регістрів $a0 та $a1 і записати результат в $v0.
    ...
    * Приклад 3:
      ...
      * $a1:5:5
      * $v0::28
 4. *Віднімання.*Відняти вміст регістру $a1 від вмісту регістра $a0 і записати результат в $v0.
    * Приклад 1:
      * $a0:65:65
      * $a1:3:3
      * $v0::62
    ...
    * Приклад 3:
      ...
      * $a1:5:5
      * $v0::18
 5. *Множення.*Перемножити вміст регістрів $a0 і $a1 та записати результат в $v0.
    * Приклад 1:
      * $a0:13:13
      * $a1:3:3
      * $v0::39
    ...
    * Приклад 3:
      ...
      * $a1:4:4
      * $v0::100
 6. *Ділення.*Розділити вміст регістру $a0 на вміст регістру $a1 і записати цілу частину до $v0.
    * Приклад 1:
      * $a0:12:12
      * $a1:3:3
      * $v0::4
...
## Варіанти завдань:
FIXME
  1. v0 = *a0+*a1-*a2. Скласти вміст двух комірок памяті по адресам із регістрів
  $a0 та $a1, відняти від суми вміст комірки памяті по адресі із регістра $a2,
  результат записати в $v0.
 ...
 4. *(!).*(!)
      ...
      * Приклад 2:
      * Приклад 3:
 5. v0 = *a0+*a1-*a2.Скласти вміст двух комірок памяті по адресам із
    регістрів $a0 та $a1, відняти від суми вміст комірки памяті по
...
## Варіанти завдань
  1. Перевірка на рівність. Присвоїти $v0 значення 1, якщо регістри $a0 та $a1
  рівні, в іншому випадку присвоїти значення 0.
  2. Визначення відсутності спільних бітів. Виконати «логічне і» регістрів $a0
  та $a1, у випадку, якщо результат рівний 0, то записати в $v0 1, інакше
  записати 0.
  3. Перевірка рівності комірок памяті. Встановити $v0 в 1, якщо дані комірк
  памяті по адресам із рестрів $a0 та $a1 рівні, інакше встановити $v0 в 0.
  4. Додавання і перевірка на нерівність. Збільшити вміст регістра $a0 на 2,
  у випадку, якщо результат більше 0, записати в $v0 1, інакше записати 0.
  5. Віднімання та перевірка на нерівність. Зменшити вміст регістра $a0 на 3,
  в випадку, якщо результат менше 0, записати в $v0 1, інакше – записати 0.
  
 1. Перевірка на рівність. Присвоїти $v0значення 1, якщо регістри $a0 та
    $a1 рівні, в іншому випадку присвоїти значення 0.
      ...
      * Приклад 3:
          ...
          * $a1:-14:-14
          * $v0::0
 1. Визначення відсутності спільних бітів. Виконати «логічне і»
    ...
    записати в $v0 1,інакше записати 0.
      ...
      * Приклад 3:
          ...
          * $a1:2:2
          * $v0::0
 3. Перевірка рівності комірок памяті. Встановити $v0в 1, якщо дані
    ...
    встановити $v0в 0.
      ...
      * Приклад 3:
          ...
          * 0x100:117:117
          * 0x104:117:117
 4. Додавання і перевірка на нерівність. Збільшити вміст регістра $a0на
    2, у випадку, якщо результат більше 0, записати в $v0 1, інакше
    записати 0.
      * Приклад 1:
          * $a0:5:7
          * $v0::1
      ...
      * Приклад 3:
          * $a0:1:3
          * $v0::1
 5. Віднімання та перевірка на нерівність. Зменшити вміст регістра $a0
...
вказівник фрейму, але компілятор С від MIPS так не робить: він розглядає регістр
